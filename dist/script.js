...
function (_Slider) {
  ...
  function MainSlider(page, btns) {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(MainSlider).call(this, page, btns)); // получаем свойства
  }
...
function Slider() {
  ...
  // передаем "" или {} (дефолтные значения), что-бы небыло ошибки если не будет аргумента, page - одна из страниц, сайт многостраничный; bnts - кнопки переключения элементов

...
window.addEventListener('DOMContentLoaded', function () {
  var slider = new _modules_slider__WEBPACK_IMPORTED_MODULE_0__["default"]('.page', '.next'); // slider - экземпляр класса
...
/*#__PURE__*/
function () {
  // можно сразу експортировать, чтобы не писать в конце. Наименование Class-ов пишется с большой буквы
  function Slider(page, btns) {
    _classCallCheck(this, Slider);

    // page - одна из страниц, сайт многостраничный; bnts - кнопки переключения элементов
